...
from app.models import Role, User, Patient, PatientAssessment, Physician
...
def seed_users():
    ...
    dummy_users = [
        {"email": "dr.stephen@avengers.com", "name": "Stephen Strange", "password": "password123",
         "role": physician_role},
        {"email": "dr.batman@dc.com", "name": "Bruce Wayne", "password": "password123",
         "role": physician_role},
